    ...
    <div class="welcome-banner mb-4">
      <div class="row align-items-center">
        <div class="col-md-8">
          ...
          <p class="text-muted mb-0">今天是个美好的一天，让我们一起把工作做得更好</p>
        </div>
        ...
        <div class="stat-card stat-card-danger">
          <div class="stat-card-body">
            ...
            <div class="stat-content">
              ...
              <div class="stat-trend stat-trend-up">
                <i class="bi bi-arrow-up"></i> +35% 较上月
              </div>
            </div>
          </div>
        </div>
    ...
    <div class="row g-3 mb-4">
      ...
      <div class="col-lg-4">
        <div class="content-card">
          ...
          <div class="content-card-body">
            <div ref="categoryChart" style="width: 100%; height: 320px;"></div>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="row g-3 mb-4">
      ...
      <div class="col-lg-6">
        <div class="content-card">
          ...
          <div class="content-card-body">
            <div ref="topProductsChart" style="width: 100%; height: 280px;"></div>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="row g-3 mb-4">
      <div class="col-lg-6">
        <div class="content-card">
          ...
          <div class="content-card-body">
            <div ref="orderStatusChart" style="width: 100%; height: 280px;"></div>
          </div>
        </div>
      </div>
          ...
          <div class="content-card-body">
            <div class="data-overview">
              <div class="overview-item">
                ...
                <div class="overview-value text-primary">{{ todayStats.newUsers }}</div>
              </div>
              <div class="overview-item">
                <div class="overview-label">今日新增订单</div>
                <div class="overview-value text-success">{{ todayStats.newOrders }}</div>
              </div>
              <div class="overview-item">
                <div class="overview-label">今日销售额</div>
                <div class="overview-value text-warning">¥{{ formatNumber(todayStats.revenue) }}</div>
              </div>
              <div class="overview-item">
                <div class="overview-label">待处理订单</div>
                <div class="overview-value text-danger">{{ todayStats.pendingOrders }}</div>
              </div>
            </div>
          </div>
        </div>
            ...
            <div class="quick-actions">
              ...
              <router-link to="/admin/users" class="quick-action-btn quick-action-info">
                ...
                <div class="action-content">
                  ...
                  <div class="action-desc">管理用户账户</div>
                </div>
                <i class="bi bi-chevron-right"></i>
              </router-link>
          ...
          <div class="content-card-body">
            <div class="system-status">
              ...
              <div class="status-item">
                ...
                <div class="status-value">{{ stats.onlineUsers }} 人</div>
              </div>
              <div class="status-item">
                <div class="status-label">
...
export default {
  ...
  methods: {
    ...
    async initSalesChart() {
      try {
        const response = await api.get('/statistics/sales-trend')
    ...
    async initCategoryChart() {
      try {
        const response = await api.get('/statistics/category-sales')
        const data = response.data || []
    ...
    async initUserGrowthChart() {
      try {
        const response = await api.get('/statistics/user-growth')
        const data = response.data
    ...
    async initTopProductsChart() {
      try {
        ...
        this.charts.topProducts.setOption({
          tooltip: {
            trigger: 'axis',
    ...
    async initOrderStatusChart() {
      try {
        const response = await api.get('/statistics/order-status')
        const data = response.data || []
        
        this.charts.orderStatus = echarts.init(this.$refs.orderStatusChart)
        this.charts.orderStatus.setOption({
          tooltip: {
            trigger: 'item',
            formatter: '{b}: {c} ({d}%)'
          },
